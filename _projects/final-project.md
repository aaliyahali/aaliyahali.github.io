...
Between January 2015 and August 2018, the FDA approved 155 new drugs and compiled demographic statistics for each, which included a recording of what percentage of trial participants were White, Black, Asian, women, or over the age of 65. ProPublica, an investigative news organization, compiled all of this information into a single dataset for the purpose of investigating racial representation in drug trials. Our analysis builds upon that premise to look at all disease categories in order to highlight systemic underreprsentation across racial demographic factors. 
...
<div style="display: flex; gap: 1rem; flex-wrap: wrap; margin-top: 0.5rem;">
  <a href="https://github.com/aaliyahali/aaliyahali.github.io/blob/main/preprocess.ipynb" class="btn btn-outline-dark">
  ...
  <a href="https://github.com/aaliyahali/aaliyahali.github.io/blob/main/clinical_trials_cleaned.csv" class="btn btn-outline-dark">
    Cleaned Dataset
  </a>
</div>